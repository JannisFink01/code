...
>{\raggedright\arraybackslash}p{2.2cm}
        ...
        \url{https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/} \\[0.4em]
 
        Judge &
        GPT-4.1 &
        Bewertung der erzeugten Multi-Turn-Gespräche im Rahmen der automatisierten Evaluation mit DeepEval. &
        \url{https://developers.openai.com/api/docs/models/gpt-4.1} \\[0.4em]
        ...
        \url{https://ai.google.dev/gemma/docs/core/model_card_4} \\[0.4em]
...
\newpage
\appendix
\section{Verwendete Prompt-Varianten}
\label{app:prompts}
