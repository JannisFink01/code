...
Version 1.7.0 stellt zusätzlich einen Verbose-Modus für Non-Streaming-Anfragen bereit. Dieser gibt unter anderem Informationen über die Vektorisierung, die Retrieval- und Fusionsergebnisse, das Reranking, die tatsächlich an das LLM übergebenen Nachrichten sowie die rohe und finale Modellantwort strukturiert aus. Der Verbose-Modus greift dabei auf bereits während der regulären Verarbeitung erzeugte Daten zurück und führt keine zusätzlichen Retrieval-, Embedding-, Reranking- oder LLM-Aufrufe aus. 

Dadurch können die einzelnen Verarbeitungsschritte für die spätere Evaluation nachvollzogen werden. Die für die Untersuchung variierten Retrieval- und Reranking-Konfigurationen werden in Abschnitt~\ref{subsec:Die RAG-Konfigurationen} beschrieben.
...
% 2 Grundlagen
% 2.1 Sokratische Didaktik / intelligentes Tutoring – was „gutes" Tutorverhalten ausmacht.
% 2.2 Retrieval-Augmented Generation – Dense/Sparse/Hybrid, RRF, Cross-Encoder-Reranking, Qdrant, Score-Threshold.
% 2.3 LLM-as-a-Judge & DeepEval – Multi-turn-ConversationalTestCase, native Turn-Metriken, G-Eval, Rubrics, Schwellenwerte.
% 2.4 Verwandte Arbeiten – bisherige RAG-Evaluation und LLM-Judge-Ansätze, Forschungslücke.
% 3 Untersuchungsgegenstand (System)
% 3.1 Die RAG-Pipeline (Qdrant + Reranking + Moodle, Verbose-Transparenz v1.7.0), Modell gemma-4-moe.
% 3.2 Die Prompt-Varianten (system_prompt, minimaler_sokrat, no_Prompt) – für RQ1.
% 3.3 Die RAG-Konfigurationen (Retrieval-Modus, Rerank, Collections) – für RQ2.